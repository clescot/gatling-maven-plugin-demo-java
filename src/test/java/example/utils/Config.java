...
public class Config {
  ...
  public static final int vu = Integer.getInteger("vu", 4); // Number of virtual users
  public static final Duration duration =
      Duration.ofMinutes(Integer.getInteger("durationMinutes", 2)); // Test duration in minutes
  public static final Duration ramp_duration =
      Duration.ofMinutes(Integer.getInteger("rampDurationMinutes", 2)); // Ramp-up duration
