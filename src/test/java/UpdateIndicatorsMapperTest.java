...
public class UpdateIndicatorsMapperTest {
    ...
    @Test
    public void testUpdateIndicatorsMapperNoUpdate() {
        // Given
        GatlingReporter gatlingReporter = new GatlingReporter();
        String gatlingConf="#########################\n" +
                "# Gatling Configuration #\n" +
        ...
        Map<String, String> updatedIndicatorsMapper = gatlingReporter.updateIndicatorsMapper(defaultIndicatorsMapper, gatlingConf);
        Map<String, String> expectedIndicatorsMapper = Maps.newHashMap();
        expectedIndicatorsMapper.put("percentiles1", "p50");
        expectedIndicatorsMapper.put("percentiles2", "p75");
        expectedIndicatorsMapper.put("percentiles3", "p95");
        expectedIndicatorsMapper.put("percentiles4", "p99");
        expectedIndicatorsMapper.put("lowerBound", "lower_bound_800");
        expectedIndicatorsMapper.put("higherBound", "higher_bound_1200");
